//
//  SearchDetailRepositoryTests.swift
//  SearchDataTests
//
...
final class SearchDetailRepositoryTests: QuickSpec {
    override class func spec() {
        ...
        describe("📦 Create SearchDetailRepository") {
            beforeEach {
                ...
                searchDetailRepository = DefaultSearchDetailRepository(networkManager: networkManager, hitHistoriesStorage: hitHistoryStorage)
            }
